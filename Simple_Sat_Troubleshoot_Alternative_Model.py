...
preprocessor_pos = ColumnTransformer(transformers=[("num_field", pipe, field)])
...
train, test = train_test_split(sat_data_df, test_size=0.20)
Field_train = train[["bx[nT]", "by[nT]", "bz[nT]"]]
Position_train = train[["bx[nT]", "by[nT]", "bz[nT]"]]
Field_test = test[["bx[nT]", "by[nT]", "bz[nT]"]]
Position_test = test[["bx[nT]", "by[nT]", "bz[nT]"]]

preprocessor_pos.fit(Position_train)
preprocessor_field.fit(Field_train)
preprocessor_pos.fit(Position_test)
preprocessor_field.fit(Field_test)
...
plt.savefig('Simple_sat_loss_Field_Input_2_Layer.pdf') 
...
plt.ylabel("B_x")
plt.title("Measured Bx versus Model Output (Field as Input)")
plt.show

plt.savefig('True_vs_Model_Bx_Field_Input_2_Layer.pdf') 
...
plt.ylabel("B_y")
plt.title("Measured By versus Model Output (Field as Input)")
plt.show

plt.savefig('True_vs_Model_By_Field_Input_2_Layer.pdf') 
...
plt.savefig('True_vs_Model_Bz_Field_Input_2_Layer.pdf')




## Use position data as input
...
plt.xlabel("Batch Number")
plt.ylabel("Loss")
plt.title("Training Loss (Position as Input)")
plt.show

plt.savefig('Simple_sat_loss_Position_Input_2_Layer.pdf') 
...
bx.legend(['Bx_true', 'output 1','output 2', 'output 3'])
plt.ylabel("B_x")
plt.title("Measured Bx versus Model Output (Position as Input)")
plt.show

plt.savefig('True_vs_Model_Bx_Position_Input_2_Layer.pdf') 
...
by.legend(['By_true', 'output 1','output 2', 'output 3'])
plt.ylabel("B_y")
plt.title("Measured By versus Model Output (Position as Input)")
plt.show

plt.savefig('True_vs_Model_By_Position_Input_2_Layer.pdf') 
...
bz.legend(['Bz_true', 'output 1','output 2', 'output 3'])
plt.ylabel("B_z")
plt.title("Measured Bz versus Model Output (Position as Input)")
plt.show

plt.savefig('True_vs_Model_Bz_Position_Input_2_Layer.pdf')