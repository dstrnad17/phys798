...
plt.savefig('Two_Layer_loss_Position_Input.pdf') 
...
plt.ylabel("B_x")
plt.title("Two_Layer_Measured Bx versus Model Output (Position as Input)")
plt.show

plt.savefig('Two_Layer_True_vs_Model_Bx_Position_Input.pdf') 
...
plt.savefig('Two_Layer_True_vs_Model_By_Field_Input.pdf') 
...
plt.savefig('Two_Layer_True_vs_Model_Bz_Position_Input.pdf')
