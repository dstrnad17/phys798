...
sat_data_df.plot(y = 'bz[nT]', kind = 'line')
plt.xlabel("Measurement")
plt.ylabel("Magnetic Field Z Component")
plt.title("Bz Measurment")
plt.show
...
train, test = train_test_split(Field_trans, test_size=0.20)
...
Ftr = Field_train.sort_index()
Ftr.plot(y = 'bz[nT]', kind = 'line')
plt.xlabel("Measurement")
plt.ylabel("Magnetic Field Z Component")
plt.title("Bz Measurment (Training Data)")
plt.show

plt.savefig('Magnetic Field Measurement Z Component (Train)') 

Fte = Field_test.sort_index()
Fte.plot(y = 'bz[nT]', kind = 'line')
plt.xlabel("Measurement")
plt.ylabel("Magnetic Field Z Component")
plt.title("Bz Measurment (Test Data)")
plt.show

plt.savefig('Magnetic Field Measurement Z Component (Test)') 

Fte = Field_test.sort_index()
Fte.plot(y = 'bz[nT]', kind = 'line')
plt.xlabel("Measurement")
plt.ylabel("Magnetic Field Z Component")
plt.title("Bz Measurment (Transformed Test Data)")
plt.show

plt.savefig('Magnetic Field Measurement Z Component (Transformed Test)')
...
sat_nn_regresion_train = train(3)
