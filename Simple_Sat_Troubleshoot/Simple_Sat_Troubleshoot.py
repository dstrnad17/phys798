...
plt.savefig('Simple_sat_loss_Field_Input.pdf') 
...
plt.savefig('True_vs_Model_Bx_Field_Input.pdf') 
...
plt.savefig('True_vs_Model_By_Field_Input.pdf') 
...
plt.savefig('True_vs_Model_Bz_Field_Input.pdf')
...
plt.savefig('Simple_sat_loss_Position_Input.pdf') 
...
plt.savefig('True_vs_Model_Bx_Position_Input.pdf') 
...
plt.savefig('True_vs_Model_By_Position_Input.pdf') 
...
plt.savefig('True_vs_Model_Bz_Position_Input.pdf')
